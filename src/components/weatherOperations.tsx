...
//             fetchWeather({ lat: latitude, lon: longitude });  // Fetch weather for current location
//           },
//           (error) => {
//             console.error('Error getting location:', error);
//             // Fallback to a default location if geolocation is not available or permission is denied
//             fetchWeather('New York');  // Default to New York
//           }
//         );
//       } else {
...
//   // Watch for changes in the city value to fetch weather data
//   useEffect(() => {
//     if (city.trim() === '') {
//       // If city is empty, fetch weather for the current location
//       if (navigator.geolocation) {
//         navigator.geolocation.getCurrentPosition(
//           (position) => {
//             const { latitude, longitude } = position.coords;
...
//         );
//       } else {
//         fetchWeather('New York'); // Fallback to New York if geolocation is not supported
//       }
//     } else {
//       fetchWeather(city.trim()); // Fetch weather based on city input
//     }
//   }, [city]);
